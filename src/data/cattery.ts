...
export const testimonials: Testimonial[] = [
  {
    ...
    quote: "Antes de contactarlos ya me habían estafado una vez con un 'persa' que resultó ser mestizo. Aquí pedí videollamada antes de pagar nada y todo coincidía con las fotos: el gato, el pedigrí, el precio. Aurelius es de una belleza hipnótica y una dulzura infinita.",
    year: "2025",
  ...
  },
  {
    ...
    quote: "La atención personalizada y el nivel de cuidado se nota desde el primer mensaje por WhatsApp. Geneviève llegó a Guayaquil perfectamente adaptada al arenero, cariñosa y con un manto impecable. El kit de bienvenida fue un detalle digno de alta gama.",
    year: "2025",
